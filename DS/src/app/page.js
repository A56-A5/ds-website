  ...
  return (
    <div className="min-h-screen" style={{ background: '#97b0c0' }}>
      ...
      <section className="flex flex-col items-center py-10">
        <div className="w-[80%] max-w-2xl mx-auto mb-2">
          <h2 className="text-2xl font-bold mb-4" style={{ color: '#163447', textAlign: 'left' }}>ABOUT</h2>
        </div>
        <div style={{ background: '#163447', border: '2.5px solid #97d655', borderRadius: '8px' }} className="w-[80%] max-w-2xl mx-auto px-2 sm:px-4 p-4 sm:p-8 shadow-lg">
          <p className="text-sm sm:text-base text-center" style={{ color: '#97d655', fontFamily: 'inherit', lineHeight: '1.5' }}>
            {aboutText.split('\n').map((line, idx) => (
              <span key={idx} style={{ display: 'block', marginBottom: '1.2em' }}>{line}</span>
            ))}
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center py-10">
        <div className="w-[80%] max-w-2xl mx-auto mb-2">
          <h2 className="text-2xl font-bold mb-4" style={{ color: '#163447', textAlign: 'left' }}>ACHIEVEMENTS</h2>
        </div>
        <div
          style={{ background: '#163447', border: '2.5px solid #97d655', borderRadius: '12px' }}
          className="w-[80%] max-w-2xl mx-auto px-2 sm:px-4 p-4 sm:p-8 shadow-lg flex flex-col items-center relative min-h-[320px] sm:min-h-[600px] max-h-[700px] justify-center"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center w-full">
            ...
            <div className="flex flex-col items-center w-full">
              <div style={{ border: '2.5px solid #97d655', borderRadius: '12px' }} className="overflow-hidden mb-6 mx-auto" >
                <img src={achievements[activeAch].image} alt={achievements[activeAch].caption} className="w-full max-w-xs sm:w-[340px] h-[180px] sm:h-[260px] object-cover" />
              </div>
              <div className="text-xl font-semibold text-center" style={{ color: '#97d655' }}>{achievements[activeAch].caption}</div>
            </div>
      ...
      <section className="flex flex-col items-center py-10">
        <div className="w-[80%] max-w-2xl mx-auto mb-2">
          <h2 className="text-2xl font-bold mb-4" style={{ color: '#163447', textAlign: 'left' }}>EVENTS</h2>
        </div>
        <div
          style={{ background: '#163447', border: '2.5px solid #97d655', borderRadius: '12px' }}
          className="w-[80%] max-w-2xl mx-auto px-2 sm:px-4 p-4 sm:p-8 shadow-lg flex flex-col items-center relative min-h-[320px] sm:min-h-[600px] max-h-[700px] justify-center"
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center w-full">
            ...
            <div className="flex flex-col items-center w-full">
              <div style={{ border: '2.5px solid #97d655', borderRadius: '12px' }} className="overflow-hidden mb-6 mx-auto" >
                <img src={events[activeEvent].image} alt={events[activeEvent].caption} className="w-full max-w-xs sm:w-[340px] h-[180px] sm:h-[260px] object-cover" />
              </div>
              <div className="text-xl font-semibold text-center" style={{ color: '#97d655' }}>{events[activeEvent].caption}</div>
            </div>
