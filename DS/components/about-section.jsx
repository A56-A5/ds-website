    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-800 mb-6">About Our Department</h2>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:scale-105 hover-lift">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">Advanced artificial intelligence and machine learning techniques</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:scale-105 hover-lift">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">Statistical analysis and predictive modeling</p>
            </CardContent>
          </Card>
